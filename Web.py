...
print(R +"●~"+ G +"What do You Want? >{Google}<  or "+R+">{instagram}<")
print( G +"["+ R +"1" + G +"]"+ W +"=="+ G +"["+ Y +"Google"+ G +"]")
print ( G +"["+ R +"2" + G +"]"+ W +"=="+ G +"["+ Y +"instagram"+ G +"]")
web=str(input(R +"              ●~"+ G +"Enter Number "+ R +"~》 "+ G))

if web == "1":
   print(R+'English'+W+' or '+Y+'Arabic?')
   print(Y+'Arabic{'+W+'1'+Y+'}\n'+R+'English{'+W+'2'+R+'}\n')
   
   ara=str(input("\033[31m ┌─["+LIGHTGREEN_EX+"Please Enter the"+BLUE+"~"+White+"@Number"+RED+"""]
 └──╼ """+White+"$ "))
...
if web == "2":
    ...
    print(Y+'Arabic{'+W+'1'+Y+'}\n'+R+'English{'+W+'2'+R+'}\n')
    insta=str(input("\033[31m ┌─["+LIGHTGREEN_EX+"Please Enter the"+BLUE+"~"+White+"@Number"+RED+"""]
 └──╼ """+White+"$ "))
